...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	if ( $count > 0 ) :
		...
		echo '<div class="star-rating" title="'.sprintf(__('Rated %s out of 5', ETHEME_DOMAIN), $average).'"><span style="width:'.($average*15).'px"><span itemprop="ratingValue" class="rating">'
					.$average.'</span> '.__('out of 5', ETHEME_DOMAIN).'</span></div>';
	...
	$comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . __( 'Your Review', ETHEME_DOMAIN )
