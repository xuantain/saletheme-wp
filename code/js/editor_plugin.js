    ...
    tinymce.create('tinymce.plugins.et_button', {  
        init : function(ed, url) {  
            ed.addButton('et_button', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[button title="Simple Button" url="#" style="big active arrow-right"]');  
    ...
    tinymce.create('tinymce.plugins.et_icon', {  
        init : function(ed, url) {  
            ed.addButton('et_icon', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[icon name="icon-bolt" size="48" color="454545"]');  
                }  
            });  
        },  
        createControl : function(n, cm) {  
    ...
    tinymce.create('tinymce.plugins.et_ptable', {  
        init : function(ed, url) {  
            ed.addButton('et_ptable', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[ptable]\r[phrow]Standart License[/phrow]\r[rowprice value="20,99" curr="$" period="mo"]\r[prow]10GB of Lorem Ipsum[/prow]\r[prow]200MB Max File Size[/prow]\r[prow]2GHZ CPU[/prow]\r[prow]256MB Memory[/prow]\r[prow]200MB Max File Size[/prow]\r[prow]<a href="#" class="button">Purchase Now</a>[/prow]\r[/ptable]');  
                }  
            });  
        },  
        createControl : function(n, cm) {  
